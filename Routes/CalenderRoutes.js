...
const {
  ...
  getAppointments,
  getBookingInfo,
  getexpertBookingInfo,
  getAllAppointments,
  getAppointment,
  updateAppointment,
  deleteAppointment,
  getDetailsUserExpert,
} = require("../CallbackFunctions/calenderCallbackFunctions");

CalenderRoutes.route("/book-online/:id")
  .get(getAppointment)
  .delete(deleteAppointment)
  .put(updateAppointment);
CalenderRoutes.route("/book-online")
