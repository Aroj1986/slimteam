      ...
      <div className="d-flex flex-column justify-content-center align-items-center mt-3 mb-3 ">
        <div className="d-flex flex-row aroj justify-content-md-between align-items-center p-2">
          <div className="hero-section">
            <h3 className="slogan" style={{ display: "inline" }}>
              Our Connection to Excellent
              {/* <p style={{margin:"0.4rem",display:"inline"}}></p><img src={logo} height={70} width={60}></img>  */}{" "}
              Services
            </h3>
            <p className="paragraph">
              <p className="paratext">
                From minor repairs to major renovations, our service experts
                have got you covered.{" "}
              </p>
              <p className="paratext">Get access to more Skilled
              Professionals or More Work by registering with our app!{" "}
            </p>
            ...
            <Button
              variant="contained"
              style={{ backgroundColor: "black", width: "9rem" }}
            >
              <NavLink
                to={`/explore-experts`}
        ...
        <div className="reviews">
          ...
          <div className="icons">
            <CleaningServicesIcon
              style={{ color: "#654321", fontSize: "2.5rem" }}
            />
